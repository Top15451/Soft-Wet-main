package com.top1545.rotp_sw.client.render.entity.model.projectile;
...
public class SoftAndWetBubbleModel extends EntityModel<SoftAndWetBubbleEntity> {
    ...
    @Override
    public void setupAnim(SoftAndWetBubbleEntity entity, float walkAnimPos, float walkAnimSpeed, float ticks, float yRotationOffset, float xRotation) {
